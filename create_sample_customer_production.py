#!/usr/bin/env python3
"""
สคริปต์สำหรับสร้างลูกค้าตัวอย่างในระบบ (สำหรับ production)
รันใน production environment ที่สามารถเชื่อมต่อฐานข้อมูลได้
"""

import os
import sys

def create_sample_customer_production():
    """สร้างลูกค้าตัวอย่างใน production"""
    try:
...
if __name__ == '__main__':
    ...
    success = create_sample_customer_production()
    if success:
        print("\n✅ เสร็จสิ้น!")
    else:
        print("\n❌ ล้มเหลว!")
